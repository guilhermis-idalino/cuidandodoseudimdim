...
<html lang="pt-BR">
    <head>
        ...
        <title>Cuidando do seu DimDim: Nova Despesa</title>
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> Despesa <i class="fa fa-angle-right"></i> Nova Despesa <i class="fa fa-angle-right"></i> <?php
                        $mes = '';
                        switch ($visao_mes) {
                            case 1:
                                $mes = 'Janeiro';
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> Nova Despesa</h4>
                                <form class="form-horizontal style-form" action="/cuidandoseudimdim/Despesa/nova_despesa/" method="POST">    
                            ...
                            echo 'value="' . $visao_valores['titulo'] . '"';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="categoria" required>
                                                ...
                                                <option value="Manutenção ou prevenção">Manutenção ou prevenção</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" name="data_vencimento" class="form-control round-form" <?php if ($visao_parametros['sit'] == "erro" || $visao_parametros['sit'] == "valor") {
                                                echo 'value="' . $visao_valores['data_vencimento'] . '"';
                                            } ?> required>
                                        </div>
                                    </div>
                                    </br>
                                    ...
                                    <div class="form-group">     
                                        ...
                                        <div class="col-sm-4">
                                            <button type="submit" class="btn btn-primary btn-lg btn-block">Registrar Despesa</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
