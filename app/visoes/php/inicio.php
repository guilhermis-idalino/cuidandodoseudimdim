...
<html lang="pt-BR">
    <head>
        ...
        <title>Cuidando do seu DimDim: Início</title>
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="mt">
                            <a class="active" href="/cuidandoseudimdim/Inicio/inicio/">
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <div class="row mt">
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 desc">
                            <div class="photo-wrapper">
                                <div class="photo">
                                    <img class="img-responsive" src="/cuidandoseudimdim/app/visoes/imagens/banner_inicial.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-10 ">
                            ...
                            <div class="row mt">
                                <div class="col-lg-12">
                                    <p><i class="fa fa-angle-right"></i> Perfil do Usuário: clique em <img src="/cuidandoseudimdim/app/visoes/imagens/ic_per.png"></p></br>
                                    <p><i class="fa fa-angle-right"></i> Para Nova e Minhas de Receitas: clique <img src="/cuidandoseudimdim/app/visoes/imagens/ic_rec.png"></p></br>
                                    <p><i class="fa fa-angle-right"></i> Para Nova e Minhas de Despesas: clique <img src="/cuidandoseudimdim/app/visoes/imagens/ic_des.png"></p></br>
                                    <p><i class="fa fa-angle-right"></i> Relatórios de Saldos: clique em <img src="/cuidandoseudimdim/app/visoes/imagens/ic_sal.png"></p></br>
                                    <p><i class="fa fa-angle-right"></i> Visualizar Tipos de Despesas: clique em <img src="/cuidandoseudimdim/app/visoes/imagens/ic_aju.png"></p></br>
                                </div>
                            </div>
                        </div>
                    </div><!-- /row -->
