...
<html lang="pt-BR">
    <head>
        ...
        <title>Cuidando do seu DimDim: Minhas Receitas</title>
      ...
      *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> Receitas <i class="fa fa-angle-right"></i> Minhas Receitas <i class="fa fa-angle-right"></i> <?php
                        $mes = '';
                        switch ($visao_mes) {
                            case 1:
                                $mes = 'Janeiro';
                        ...
                        <div class="col-lg-12">
                            <div class="content-panel">
                                <div class=" add-task-row">
                                    <a class="btn btn-success btn-sm pull-right" href="/cuidandoseudimdim/Receita/nova_receita">Nova Receita</a>
                                </div> 
                                ...
                                <section id="unseen">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody>
                                            <?php
                                            if (is_array($visao_receitas)) {
                                                foreach ($visao_receitas as $receita) {
                                                    echo '<tr>';
                                                    echo '<td>' . $receita['titulo'] . '</td>';
                                                    echo '<td class="numeric">R$ ' . $receita['valor'] . '</td>';
                                                    echo '<td>' . date('d/m/y', strtotime($receita['data_recebimento'])) . '</td>';
                                                    echo '</tr>';
                                                }
                                            }
                                            ?>
